...
function render(){
 renderRewards();const ready=tasks.filter(t=>t.status==='ready'),done=tasks.filter(t=>t.status==='done'),unfinished=tasks.filter(t=>t.status==='ready'||t.status==='scored'),pending=tasks.filter(t=>t.status==='scored');
